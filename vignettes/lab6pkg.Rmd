...
#parallel
system.time(brute_force_knapsack(knapsack_objects[1:12,],3500,TRUE))
```

<p> After profiling, it can be seen that it is taking too much time in serial operation.The time taken for $n=16$ objects. After parallelizing brute force function, the running time is shortened significantly.
