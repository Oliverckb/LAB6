...
#brute_force_knapsack(knapsak_objects[1:12,],2000)
...
<p> The Algorithm can be executed and the time taken for n=500 objects as shown below.
...
<p> The Algorithm can be executed and the time taken for n=10000 objects as shown below.
